    ...
    return Scaffold(
      ...
      body: Padding(
        padding: EdgeInsets.only(
            top: AppConstants.adaptiveScreen.setWidth(150),
            bottom: AppConstants.adaptiveScreen.setWidth(30),
            right: AppConstants.adaptiveScreen.setWidth(30),
            left: AppConstants.adaptiveScreen.setWidth(30)),
        child: Container(
          child: ListView(
            children: [
              Image.asset(
              ...
              Center(
                child: Text(
                  'Enter Your Email Address we will send you a link to enter new password',
                  ...
                  decoration: InputDecoration(
                      ...
                      focusedBorder: UnderlineInputBorder(
                          borderSide: BorderSide(
                              color: AppColors.primaryBackgroundColor)),
                      hintStyle: TextStyle(
                          fontSize: AppConstants.adaptiveScreen.setSp(32),
                          color: AppColors.primaryBackgroundColor),
